...
import 'package:rescue_app/src/repository/authentication_repository/exceptions/signup_email_password_failure.dart';
  ...
  Future<void> loginWithEmailAndPassword(String email, String password) async {
    try {
      ...
      if (e.code == 'invalid-password') {
        Get.snackbar('Error', 'Invalid password. Try again.');
      }
      if (e.code == "invalid-email-verified") {
        Get.snackbar('Error', "Email does not exist. Try again.");
      }
      if (e.code == "invalid-email") {
        Get.snackbar('Error', "Invalid Email. Try again.");
      }
    } catch (_) {}
  }
